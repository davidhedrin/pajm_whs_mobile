...
export const GlobalConfirmModal = () => {
  ...
  return (
    <Modal transparent visible={visible} animationType="fade" onRequestClose={() => closeConfirm(false)}>
      <TouchableWithoutFeedback onPress={() => closeConfirm(false)}>
        <View className="flex-1 justify-center items-center bg-black/40">
          <TouchableWithoutFeedback>
            <View
              className="w-[65%] rounded-xl shadow-lg overflow-hidden"
